...
\033[1;94m ┈┈┈▕▕4BDUL▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕B4 M4▏▏┈┈┈

\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈

\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94 KA_BHATTI.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈

\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈

\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲

\033[1;96m................\033[1;93ABDUL\033[1;91m...............

\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : Abdul Musawir

\033[1;92m☞ WhatsApp   : 03011221657

\033[1;95m☞ YouTube    : https://youtube.com/channel/UCHtanWBPiirRPddvjbEsWVA
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://youtube.com/channel/UCHtanWBPiirRPddvjbEsWVA')
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update ABDUL Tool')

	print (S + '[' + P + '☞3' + S + ']' + S + ' ABDUL WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/ABDUL')

	    os.system('cd $HOME && git clone https://github.com/devilhere0/devilhere.git')
	    ...
	    psb('WellCome To ABDUL')

	    psb('Congratulations ABDUL Tool Has Been Updated Successfully')

	    psb('🔓User Name☆ Abdul✓')

	    psb('🔓Password ☆ Shikari✓')

	    psb('Subscrib My Youtube Channel Shikari✓')

	    psb('Please Login Again')

	    time.sleep(2)

	    os.system('cd $HOME/KA_BHATTI && python2 devil.py')
...
def pak():
    ...
    print (S + '[' + Y + '☞4' + S + ']' + Y + ' Extract A File ')
